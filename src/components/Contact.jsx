      ...
      <div className="container">
        ...
        <div className="contact-grid">
          ...
          <div className="contact-info">
            <h3 className="heading-md">Direct Connection</h3>
            <div className="info-cards">
              <div className="info-card glass-card">
                <div className="info-icon">📧</div>
                <div>
                  <p className="info-label">Email</p>
                  <p className="info-value">fugdu73@gmail.com</p>
                </div>
              </div>
              <div className="info-card glass-card">
                <div className="info-icon">📍</div>
                <div>
                  ...
                  <p className="info-value">Available Worldwide</p>
                </div>
              </div>
              <div className="info-card glass-card">
                <div className="info-icon">💼</div>
                <div>
                  ...
                  <p className="info-value status-available">
            ...
            <div className="social-links">
              <a href="https://github.com/podo-abel" className="social-link" aria-label="GitHub" target="_blank" rel="noopener noreferrer">
